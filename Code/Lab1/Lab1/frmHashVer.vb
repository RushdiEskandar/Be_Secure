...
Public Class frmHashVer
    ...
    Private Sub frmHashVer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnBrowse.Click
        If OpenFileDialog1.ShowDialog = DialogResult.OK Then
            ...
            ' Si l'utilisateur a cliqué sur OK, on récupère le chemin du fichier sélectionné
            Dim path As String = OpenFileDialog1.FileName
            ' Et on l'affiche dans la case
            txtFileLocation.Text = path

            ' Et on calcule les Hashs : MD5, SHA-1 et SHA-256
            lblMD5.Text = md5_hash(path)
            lblSha1.Text = sha_1(path)
            lblSha256.Text = sha_256(path)
        End If
    End Sub
